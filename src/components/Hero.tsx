...
import { Search, TrendingUp, Shield, User, LogOut } from 'lucide-react'
        ...
        <div className="text-center">
          <div className="flex justify-center mb-8">
            <div className="bg-white/10 backdrop-blur-sm rounded-full p-6">
              <DomainVaultLogo size="xl" variant="icon-only" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              ...
              { icon: () => <DomainVaultLogo size="sm" variant="icon-only" />, title: "Secure Transactions", desc: "Protected payments with 1% marketplace fee" }
            ].map((feature, index) => (
